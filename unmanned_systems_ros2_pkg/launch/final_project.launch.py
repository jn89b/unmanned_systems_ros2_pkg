...
def generate_launch_description():
    ...
    world = os.path.join(get_package_share_directory('unmanned_systems_ros2_pkg'),
                            'worlds', world_file_name)
    ...
    launch_file_dir = os.path.join(get_package_share_directory(
        'unmanned_systems_ros2_pkg'), 'launch')
    ...
    spawn_second_tb = Node(
        ...
        executable="foot_ninja_spawn.py",
        name='foot_ninja_spawn',
        namespace=name,
        parameters=[
                    {'gazebo_name' : name}, 
                    {'x_pos': spawn_x_val }, 
